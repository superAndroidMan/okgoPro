...
public abstract class JsonHeaderCallback<T> extends CommonCallBack<T> {

    private Type type;
    private Class<T> clazz;
    private String TAG = getClass().getSimpleName();

    public JsonHeaderCallback() {
    }

    public JsonHeaderCallback(Type type) {
        this.type = type;
    }

    public JsonHeaderCallback(Class<T> clazz) {
        this.clazz = clazz;
    }
